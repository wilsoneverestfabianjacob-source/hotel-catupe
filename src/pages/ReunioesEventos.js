    ...
    <main className="home-container">
      ...
      <section className="home-content">
        <div className="hotel-info-container">
          <h2 className="hotel-info-title">{t("eventosTitulo")}</h2>

          <p className="hotel-info-paragraph">{t("eventosTexto1")}</p>
          <p className="hotel-info-paragraph">{t("eventosTexto2")}</p>
          <p className="hotel-info-paragraph">{t("eventosTexto3")}</p>
          <p className="hotel-info-paragraph bold">{t("eventosTexto4")}</p>

          <div className="hotel-mini-gallery">
            <img src="/images/foto10.jpg" alt="Foto 10" className="mini-img" />
            <img src="/images/foto11.jpg" alt="Foto 11" className="mini-img" />
            <img src="/images/foto12.jpg" alt="Foto 12" className="mini-img" />
          </div>
        </div>
      </section>
    </main>
...
export default ReunioesEventos;
