    ...
    <main className="home-container">
      ...
      <section className="home-content">
        <div className="hotel-info-container">
          <h2 className="hotel-info-title">{t("contactos")}</h2>

          <p className="hotel-info-paragraph icon-local">
            <a
              href="https://maps.google.com/?q=Avenida+Eduardo+Mondlane,+Cuamba,+Moçambique"
              target="_blank"
          ...
          <p className="hotel-info-paragraph icon-phone">
            <a className="underline-contact" href="tel:+258847381617">
              {t("contactosTelefoneReservas")}
            </a>
            <br />
            <a className="underline-contact" href="tel:+258871381617">
              {t("contactosTelefoneInfo")}
            </a>
          </p>

          <p className="hotel-info-paragraph icon-email-left">
            <a className="underline-contact" href="mailto:reservas@hotelcatupe.co.mz">
              {t("contactosEmailReservas")}
            </a>
            <br />
            <a className="underline-contact" href="mailto:info@hotelcatupe.co.mz">
              {t("contactosEmailInfo")}
            </a>
          </p>

          <p className="hotel-info-paragraph bold">
            {t("contactosTextoFinal")}
          </p>
        </div>
      </section>
    </main>
