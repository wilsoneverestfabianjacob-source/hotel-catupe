...
function RestauranteBar() {
  ...
  async function handleSubmit(e) {
    ...
    if (newErrors.email) messages.push(t("erroEmailSimbolo"));
    if (newErrors.telefone) messages.push(t("erroTelefoneNumeros"));
    if (!form.checkbox) messages.push(t("politicaPrivacidadeObrigatoria"));
    ...
    <main className="home-container">
      ...
      <section className="home-content">
        <div className="hotel-info-container">
          <h2 className="hotel-info-title">{t("restaurante")}</h2>
          ...
          <p className="hotel-info-paragraph">
            <strong>{t("horarioFuncionamento")}</strong>
          </p>

          <div className="horario-block">
            <div className="horario-espaco"></div>

            <i className="horario-titulo">{t("pequenoAlmoco")}</i>
            <div className="horario-espaco"></div>
            <ul className="horario-lista">
              <li>{t("pequenoAlmocoHorario")}</li>
            </ul>

            <div className="horario-espaco-grande"></div>

            <i className="horario-titulo">{t("almoco")}</i>
            <div className="horario-espaco"></div>
            <ul className="horario-lista">
              <li>{t("almocoALaCarte")}</li>
              <li>{t("almocoBuffetBacalhau")}</li>
            </ul>

            <div className="horario-espaco-grande"></div>

            <i className="horario-titulo">{t("jantar")}</i>
            <div className="horario-espaco"></div>
            <ul className="horario-lista">
              <li>{t("jantarALaCarte")}</li>
              <li>{t("jantarEsplanada")}</li>
            </ul>
          </div>

          <p className="hotel-info-paragraph bold">
            {t("restauranteTextoFinal")}
          </p>

          <div className="hotel-mini-gallery">
            <img src="/images/foto7.jpg" alt="Foto 7" className="mini-img" />
            <img src="/images/foto8.jpg" alt="Foto 8" className="mini-img" />
            <img src="/images/foto9.jpg" alt="Foto 9" className="mini-img" />
          </div>
        </div>
      </section>
    </main>
