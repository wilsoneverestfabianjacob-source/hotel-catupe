    ...
    <main className="home-container">
      ...
      <section className="home-content">
        <div className="hotel-info-container">
          <h2 className="hotel-info-title">{t("galeriaTitulo")}</h2>

          <p className="hotel-info-paragraph">{t("galeriaTexto1")}</p>
          <p className="hotel-info-paragraph">{t("galeriaTexto2")}</p>
          <p className="hotel-info-paragraph">{t("galeriaTexto3")}</p>
          <p className="hotel-info-paragraph bold">{t("galeriaTexto4")}</p>

          <div className="hotel-mini-gallery">
            <img src="/images/foto1.jpg" alt={t("galeriaFoto1")} className="mini-img" />
            <img src="/images/foto2.jpg" alt={t("galeriaFoto2")} className="mini-img" />
            <img src="/images/foto3.jpg" alt={t("galeriaFoto3")} className="mini-img" />
          </div>

          <div className="hotel-mini-gallery">
            <img src="/images/foto4.jpg" alt={t("galeriaFoto4")} className="mini-img" />
            <img src="/images/foto5.jpg" alt={t("galeriaFoto5")} className="mini-img" />
            <img src="/images/foto6.jpg" alt={t("galeriaFoto6")} className="mini-img" />
          </div>

          <div className="hotel-mini-gallery">
            <img src="/images/foto7.jpg" alt={t("galeriaFoto7")} className="mini-img" />
            <img src="/images/foto8.jpg" alt={t("galeriaFoto8")} className="mini-img" />
            <img src="/images/foto9.jpg" alt={t("galeriaFoto9")} className="mini-img" />
          </div>

          <div className="hotel-mini-gallery">
            <img src="/images/foto10.jpg" alt={t("galeriaFoto10")} className="mini-img" />
            <img src="/images/foto11.jpg" alt={t("galeriaFoto11")} className="mini-img" />
            <img src="/images/foto12.jpg" alt={t("galeriaFoto12")} className="mini-img" />
          </div>
        </div>
      </section>
    </main>
